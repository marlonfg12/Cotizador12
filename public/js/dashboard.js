...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderMetricas() {
    ...
    const kpis = [
      {
        tipoClase: '',
        iconoSvg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,
        titulo: 'Cotizaciones',
        valor: activas.length,
        detalle: 'activas',
      },
      {
        tipoClase: 'venta-kpi__icono--ventas',
        iconoSvg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>`,
        titulo: 'Ventas aprobadas',
        valor: UI.money(totalAprobadas),
        detalle: `${aprobadas.length} aprobadas`,
      },
      {
        tipoClase: 'venta-kpi__icono--pendientes',
        iconoSvg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`,
        titulo: 'Pendientes',
    ...
    metricas.innerHTML = kpis
      .map(
        ...
        <article class="venta-kpi">
          <div class="venta-kpi__icono ${k.tipoClase}">${k.iconoSvg}</div>
          <div class="venta-kpi__contenido">
            <small class="venta-kpi__titulo">${k.titulo}</small>
            <strong class="venta-kpi__valor">${k.valor}</strong>
            <span class="venta-kpi__detalle">${k.detalle}</span>
          </div>
        </article>
      `
      )
